...
const InformationB = ({navigation}) => {
  ...
  return (
    ...
    <TouchableOpacity style = {{flexDirection:'row',marginTop:20,marginBottom:30}}onPress={()=>{navigation.navigate('Home')}}>
        ...
        <Card.Cover style={{maxHeight:150,width:130,marginTop:10}}source={{ uri: 'https://cdn01.pharmeasy.in/dam/products/049311/crocin-advance-500mg-strip-of-15-tablets-3-1653986116.jpg' }} />
        <Card.Content>
      <Title style={{fontFamily:'bold',textAlign:'center',fontFamily:'poppins'}}>Crocin 650 Advance</Title>
        ...
        Crocin 650 Advance tablet is a pain-relieving medicine.It contains paracetamol as an active ingredient.It is used for reducing fever and relieving pain.
        </Text>
        <Divider style={{margin:25}} width={1} orientation='vertical'/>
        <Text style={{fontWeight:'bold',fontSize:16,color:'rgba(54,112,8,.96)',marginLeft:20,fontFamily:'poppins'}}>
            Use when
        ...
        <View style={{height:70,marginLeft:20,marginRight:20,backgroundColor:'rgba(151,219,97,.29)',marginBottom:40}}>
            ...
            <Text style={{fontSize:13,fontFamily:'poppins',fontWeight:300,margin:15}}>
              <B>  Q: Can I drive if I have consumed Crocin 650 Advance tablet?{'\n'}  A:</B> Crocin 650 Adavance tablet is not likely to affect your ability to drive or use machines.
